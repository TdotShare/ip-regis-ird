                                    ...
                                    <>

                                        {
                                            !viewModel.edit ?
                                                ...
                                                <form ref={viewModel.ref_update} onSubmit={viewModel.submitUpdate} >

                                                    <div className="form-row">
                                                        <div className="form-group col-md">
                                                            <label >คำนำหน้า</label>
                                                            <select className="custom-select" defaultValue={viewModel.editPeople?.people_title} name="people_title">
                                                                <option value={""}>เลือกคำนำหน้า</option>
                                                                <option value={"นาย"}>นาย</option>
                                                                <option value={"นาง"}>นาง</option>
                                                                <option value={"นางสาว"}>นางสาว</option>
                                                        ...
                                                        <div className="form-group col-md">
                                                            <label >ชื่อจริง</label>
                                                            <input type="text" className="form-control" defaultValue={viewModel.editPeople?.people_firstname} name="people_firstname" />
                                                        </div>
                                                        <div className="form-group col-md">
                                                            <label >นามสกุล</label>
                                                            <input type="text" className="form-control" defaultValue={viewModel.editPeople?.people_lastname} name="people_lastname" />
                                                        </div>
                                                    </div>
                                                    <div className="form-row">
                                                        <div className="form-group col-md-12">
                                                            <label >ที่อยู่</label>
                                                            <input type="text" className="form-control" defaultValue={viewModel.editPeople?.people_address} name="people_address" />
                                                        </div>
                                                    </div>
                                                    <div className="form-row">
                                                        <div className="form-group col-md">
                                                            <label >เบอร์</label>
                                                            <input type="text" className="form-control" defaultValue={viewModel.editPeople?.people_tel} name="people_tel" />
                                                        </div>
                                                        <div className="form-group col-md">
                                                            <label >Email</label>
                                                            <input type="text" className="form-control" defaultValue={viewModel.editPeople?.people_email} name="people_email" />
                                                        </div>
                                                        <div className="form-group col-md">
                                                            <label >สัดส่วนการประดิษฐ์/สร้างสรรค์ (%)</label>
                                                            <input type="number" className="form-control" defaultValue={viewModel.editPeople?.people_process} name="people_process" />
                                                        </div>
                                                    </div>

                                                    <div className="form-row">
                                                        <div className="form-group col-md">
                                                            <label >รูปภาพประจำตัว ( <a target={`_blank`} href={`${Public_path}/${viewModel.id}/people/${viewModel.editPeople?.people_image}`} >ไฟล์ปัจจุบัน</a> )</label>
                                                            <input type="file" className="form-control" accept='image/jpeg,image/png' name='people_image_file' />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="form-row">
                                                        <div className="form-group col-md">
                                                            <label >สถานะ</label>
                                                            <select className="custom-select" defaultValue={viewModel.editPeople?.people_type} name="people_type">
                                                                <option value={""}>กรุณาเลือกสถานะ ผู้ประดิษฐ์ / ผู้สร้างสรรค์</option>
                                                                <option value={"บุคลากร มทร.อีสาน"}>บุคลากร มทร.อีสาน</option>
                                                                <option value={"นักศึกษา มทร.อีสาน"}>นักศึกษา มทร.อีสาน </option>
                                                                <option value={"บุคคลภายนอก"}>บุคคลภายนอก</option>
                                                    ...
                                                    <div className="form-row">
                                                        <div className="form-group col-md">
                                                            <label >ชื่อผู้ประดิษฐ์ลำดับแรก</label>
                                                            <select className="custom-select" defaultValue={viewModel.editPeople?.people_head} name="people_head">
                                                                <option value={""}>ตั้งให้เป็นชื่อผู้ประดิษฐ์ลำดับแรกหรือไม่ ?</option>
                                                                <option value={"1"}>เป็น</option>
                                                                <option value={"0"}>ไม่เป็น </option>
                                                            </select>
                                                    ...
                                                    <div className='row'>
                                                        <div className='col'><button onClick={() => viewModel.actionEdit_off()} className="btn btn-block btn-danger">ยกเลิกการแก้ไข</button></div>
                                                        <div className='col'><button type="submit" className="btn btn-block btn-success">แก้ไขข้อมูล</button></div>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        {
                                                            viewModel.qe_people_data.data?.data.map((el, index) => (
                                                                <tr key={index} >
                                                                    ...
                                                                    <td><button onClick={() => viewModel.actionEdit_on(el)} className='btn btn-block btn-primary'>แก้ไขข้อมูล</button></td>
